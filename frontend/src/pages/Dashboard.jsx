...
export default function Dashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        setDashData(await getDashboardData());
      } catch (err) {
    ...
    <div className="p-8">
      <header className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Tinjau pergerakan harga emas dari dataset yang dipilih.
          </p>
          <p className="text-sm italic text-slate-400 mt-2">
            Data mengikuti dataset yang dimuat.
          </p>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-slate-500 text-sm font-medium">Harga Emas Antam (24h)</p>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <p className="text-slate-500 text-sm font-medium">Harga Terendah</p>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <p className="text-slate-500 text-sm font-medium">Harga Tertinggi</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
        <div className="bg-white p-6 rounded-2xl border border-slate-100 ">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
              <span className="text-sm text-slate-500 ">Volatilitas (30d)</span>
              <span className="text-sm font-semibold">{volatility}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
              <span className="text-sm text-slate-500 ">Sentimen Pasar</span>
            ...
            <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
              <span className="text-sm text-slate-500 ">Prediksi Besok</span>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 ">
          ...
          <textarea
            ...
            rows={5}
            className="w-full text-sm text-slate-500 leading-relaxed bg-transparent border-none focus:ring-0 resize-none p-0"
